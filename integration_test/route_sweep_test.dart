...
import '../test/core/storage/in_memory_key_value_store.dart';
...
const _routes = <String>[
  ...
  AppRoute.setlists,
  AppRoute.chords,
  AppRoute.practiceHub,
  AppRoute.practiceSetup,
  AppRoute.practiceGeneratorSetup,
  AppRoute.practiceGeneratorToday,
  AppRoute.songTrainerLibrary,
  AppRoute.songTrainerImport,
  AppRoute.songTrainerNewEditor,
  AppRoute.tutorHome,
  AppRoute.tutorChat,
  AppRoute.tutorProfile,
  AppRoute.tutorPrivacy,
  AppRoute.tutorData,
  AppRoute.visionSetup,
  AppRoute.visionGuitarGeometry,
  AppRoute.analysisOverview,
  AppRoute.analysisTimeline,
  AppRoute.analysisCompare,
  AppRoute.gamificationHub,
  AppRoute.achievements,
  AppRoute.quests,
  AppRoute.streakDetail,
  AppRoute.rewardInbox,
  AppRoute.levelDetail,
  AppRoute.coachHome,
  AppRoute.profileHome,
  AppRoute.practiceLive,
  AppRoute.practiceAnalyze,
  AppRoute.practiceLearn,
  AppRoute.practiceTuner,
  AppRoute.practiceMetronome,
  AppRoute.practiceChords,
  AppRoute.songsSetlists,
  AppRoute.welcome,
  AppRoute.recovery,
  AppRoute.login,
];
