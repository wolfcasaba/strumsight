...
A security re-review (`e07-r19-security.md`) S-01-et és S-02-t a
`0758a2a0` javításon lezárta. Nincs nyitott BLOCKER vagy MAJOR; a merge az
exact-SHA Full Gate és Router CI zöld eredményétől függ.
