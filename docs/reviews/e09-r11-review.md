...
- **Státusz:** OPEN — körben javítható (kis diff, ugyanabban a fájlban), nem hizlalja érdemben a scope-ot.
...
- **Státusz:** OPEN — follow-up-ként is elfogadható (a `privacy.py` precedens ugyanezt a korlátot hordozza, nem ÚJ regresszió), de dokumentálva legyen a HANDOFF-ban.
