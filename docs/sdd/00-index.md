...
| 5 | Epic 4: AI Guitar Teacher | 24 | Chapter 2; Chapter 3 és 7 evidenciakontraktusai | [`05-epic-04-ai-guitar-teacher.md`](05-epic-04-ai-guitar-teacher.md) | specifikálva | nincs önálló mérés ebben a körben | ch07 |
| 6 | Epic 5: Computer Vision | 30 | Chapter 2; kamera spike | [`06-epic-05-computer-vision.md`](06-epic-05-computer-vision.md) | specifikálva | nincs önálló mérés ebben a körben | ch02 |
| 7 | Epic 6: Audio Analysis 2.0 | 30 — implementation evidence recorded; rollout stays at shadow, release blockers remain | Chapter 2; meglévő Analyze/DSP baseline | [`07-epic-06-audio-analysis-2.md`](07-epic-06-audio-analysis-2.md) | [`epic-06-completion-report.md`](epic-06-completion-report.md) | implementation evidence recorded (shadow rollout) | ld. `epic-06-completion-report.md` — release blockerek nyitva | ch02 |
| 8 | Epic 7: AI Practice Generator | 30 | Chapter 3, 5 és 7 | [`08-epic-07-ai-practice-generator.md`](08-epic-07-ai-practice-generator.md) | specifikálva | nincs önálló mérés ebben a körben | ch03, ch07 |
| 9 | Epic 8: Gamification | 30 | Chapter 3 és 8 eseményei | [`09-epic-08-gamification.md`](09-epic-08-gamification.md) | specifikálva | nincs önálló mérés ebben a körben | ch03, ch08 |
| 10 | Epic 9: Community Platform | 32 | Chapter 2 és 9; backend migráció | [`10-epic-09-community-platform.md`](10-epic-09-community-platform.md) | specifikálva | nincs önálló mérés ebben a körben | ch02, ch09 |
| 11 | Epic 10: Offline AI | 32 | Chapter 5 gateway contract; Chapter 2 platform | [`11-epic-10-offline-ai.md`](11-epic-10-offline-ai.md) | specifikálva | nincs önálló mérés ebben a körben | ch02, ch05 |
| 12 | Release Roadmap, Sprint Planning & Final Integration | 36 | Chapter 1–11 specifikációja és megvalósítási állapota | [`12-release-roadmap-final-integration.md`](12-release-roadmap-final-integration.md) | folyamatban (10 nyitott blocker: P0×1, P1×5, P2×4) | ld. `docs/release/program-baseline.md` + `docs/release/blockers.md` (E12-R01 mérés, 2026-08-28) | ch01–ch11 |
| 13 | UI/UX Design System & Screen Specification | 36 | cross-cutting; Chapter 1–12 felületei | [`13-chapter-13-ui-ux-design-system.md`](13-chapter-13-ui-ux-design-system.md) | specifikálva | nincs önálló mérés ebben a körben | ch01, ch12 |
| 14 | Recognition Accuracy & Useful UI Recovery | 42 | Chapter 7 audio analysis; Chapter 13 UI | [`14-chapter-14-recognition-ui-recovery.md`](14-chapter-14-recognition-ui-recovery.md) | specifikálva | nincs önálló mérés ebben a körben | ch07, ch13 |
