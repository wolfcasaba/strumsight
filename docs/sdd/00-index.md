...
| 14 | Recognition Accuracy & Useful UI Recovery | 42 | Chapter 7 audio analysis; Chapter 13 UI | [`14-chapter-14-recognition-ui-recovery.md`](14-chapter-14-recognition-ui-recovery.md) | — | nyitva (**19/42 done** — az `E14-R01…R19` sáv leszállítva és merge-elve, queue-státusz `done`, briefek + reviewk a fán; az R20–R42 briefjei közül az `E14-R40/R41/R42` megírva, a többi nyitva). A felismerési kapuk közül **egyetlen sem PASS**: onset F1@50 ms 0,674 (kapu 0,82), chord accuracy 0,671 (kapu 0,80), a direction/N.C./latency/kalibráció blokk `not-measured` — soronkénti verdikt: [`docs/release/ch14-production-gate.md`](../release/ch14-production-gate.md) (E14-R42, [ADR 0543](../adr/0543-ch14-production-gate-and-traceability-closure.md)) | ld. `program-completion-report.md` §3, §4 (E14, 2026-09-02 mérés) | ch07, ch13 |
