...
| — | Ch17 teljes bekötés (nincs SDD-fejezetfájl a `docs/sdd/` alatt) | E17 | 1 | 5 | 0 | 8 | nyitva (E17-R01 done; R02–R05 és R07 pending — a mesterséges sorosítás feloldva, PR #593; R06 és R08–R14 hold — a 23 sehonnan sem hivatkozott képernyő bekötése, `docs/plans/chapter-17-full-wiring.md`) | — |
