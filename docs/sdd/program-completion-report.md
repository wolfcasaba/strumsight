...
A completion matrix (§3) minden sora egy **queue-előtaghoz** (`E01`…`E18`,
...
| — | Ch17 teljes bekötés (nincs SDD-fejezetfájl a `docs/sdd/` alatt) | E17 | 4 | 3 | 0 | 8 | nyitva (E17-R01/R02/R03/R15 done — az R03 tartalma a pipeline-on kívül landolt (`25b518457`, ADR 0522); R04, R05 és R07 pending — a mesterséges sorosítás feloldva, PR #593; R06 és R08–R14 hold — a 23 sehonnan sem hivatkozott képernyő bekötése, `docs/plans/chapter-17-full-wiring.md`) | — |
