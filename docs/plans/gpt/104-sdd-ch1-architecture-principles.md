---
id: 104
topic: SDD Ch1 — Architecture & Engineering Principles (offline-first, privacy, rétegek, failure modell, DoD alap)
tags: [sdd, architecture, principles, clean-architecture, offline-first]
status: active
depends_on: [101]
