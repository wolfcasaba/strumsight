---
id: 126
topic: SDD Ch12 — Release Roadmap & Final Integration: 42 kör / 36 sprint (2026-08-03 referencia-start), release stage-ek (Alpha→Beta→RC→GA), versioning/provenance/SBOM, kill switch, device matrix, incident response
tags: [sdd, release, roadmap, sprints, integration, rollout, governance, ci]
status: active
