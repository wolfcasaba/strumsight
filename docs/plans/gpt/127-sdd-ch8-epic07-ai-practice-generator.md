---
id: 127
topic: SDD Ch8 / Epic 7 — AI Practice Generator: 30 kör (deterministic-first adaptív terv-generátor, skill gap elemzés, napi/heti plan, planned rest, Practice Engine compiler)
tags: [sdd, epic7, practice-generator, planning, adaptive, skills, deterministic]
status: active
depends_on: [106, 108, 110]
canonical_target: docs/sdd/08-epic-07-ai-practice-generator.md
as_built: docs/sdd/08-epic-07-ai-practice-generator.md (E01-R01, r207)
verify: determinisztikus plan-generálás azonos inputra + validator gate + Practice Engine-re fordítható blokkok
source: chatgpt-plan 2026-07-28 (Codex Execution Pack, batch 3 — a hiányzó Ch8)
---
