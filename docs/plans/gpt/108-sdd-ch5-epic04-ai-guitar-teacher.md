---
id: 108
topic: SDD Ch5 / Epic 4 — AI Guitar Teacher: 24 kör (evidence-alapú tutor, TutorModelGateway, kurált tudásbázis+RAG, tool/action confirmation, deterministic fallback)
tags: [sdd, epic4, ai-tutor, rag, llm, gateway, prompt, safety, privacy]
status: active
