---
id: 110
topic: SDD Ch7 / Epic 6 — Audio Analysis 2.0: 30 kör (AnalysisDocument, capability/confidence modell, beat grid, tempo curve, timing/dynamics metrikák, insight engine, Library V2)
tags: [sdd, epic6, analyze, dsp, metrics, confidence, timing, insights, migration]
status: active
depends_on: [105]
canonical_target: docs/sdd/07-epic-06-audio-analysis-2.md
as_built: docs/sdd/07-epic-06-audio-analysis-2.md (E01-R01, r207)
verify: legacy AnalyzeResult migráció + real-audio evaluation gate (r199 harness)
