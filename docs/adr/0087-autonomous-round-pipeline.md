...
> egy Terra és a router `STOPPED` eredménye a kötött határ; a régi szabály
> csak explicit legacy motorra marad. Review/CI/merge és az epic-zárás
> tulajdonjoga változatlan.
...
| H4 | **BLOCKER vagy MAJOR** lelet, amely három MiniMax javító kör **és egy Codex-eszkalációs javító kör** után is nyitva van — a MiniMax-kudarc utáni Codex-átvétel automatikus (user-döntés), *(2026-07-31-i user-döntés: az eredeti „egy javító kör" küszöböt a user automatikus javító körökre módosította — a leletlistás javító kör a lánc normál útja, nem megállási ok)* |
