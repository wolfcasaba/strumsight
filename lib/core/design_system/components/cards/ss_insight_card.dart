...
/// An AI-derived observation about the player's practice (§3). Every
/// [SsInsightCard] IS AI content by definition, so [provenance] is
/// **required** and its [SsProvenanceBadge] always renders in the card's
/// base state, never behind a detail view (ADR 0278 §1/§5.1, §0.0/D4,
/// fix1/F4) — there is no way to construct a provenance-less insight card.
/// Non-AI content belongs in [SsContentCard] instead.
