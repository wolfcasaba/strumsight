...
/// `SsCard`, `SsContentCard`, `SsConfirmationSheet`) are present, regardless
/// of whether the ambient app theme (`core/theme/app_theme.dart`) already
/// provides them.
///
...
final class SettingsThemeScope extends StatelessWidget {
