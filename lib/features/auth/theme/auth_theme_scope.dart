...
/// `SsCard`) are present, regardless of whether the ambient app theme
/// (`core/theme/app_theme.dart`) already provides them.
///
/// Measured (2026-08-27, the same fact `progress_theme_scope.dart`,
/// `library_theme_scope.dart` and `vision_theme_scope.dart` record for their
/// own features): `AppTheme` carries only `AppPalette`, never the design
...
final class AuthThemeScope extends StatelessWidget {
