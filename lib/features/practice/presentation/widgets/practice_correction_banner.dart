...
class PracticeCorrectionBanner extends StatelessWidget {
  ...
  static String textFor(AppLocalizations l10n, PracticeCorrection correction) =>
      switch (correction.kind) {
        PracticeCorrectionKind.recognitionUnclear => _rejectReasonText(
          l10n,
          correction.rejectReasonCode,
        ),
        PracticeCorrectionKind.playExpectedChord =>
          l10n.practiceCorrectionPlayChord(correction.expectedChord ?? ''),
