...
/// need (`SsColorScheme`, `SsTypography`, ... — consumed by `SsButton`,
/// `SsModelStatusCard`, `SsProvenanceBadge`) are present, regardless of
/// whether the ambient app theme (`core/theme/app_theme.dart`) already
/// provides them.
///
/// Measured (2026-08-27, the same fact `progress_theme_scope.dart` and
/// `library_theme_scope.dart` record for their own features): `AppTheme`
...
final class OfflineAiThemeScope extends StatelessWidget {
  const OfflineAiThemeScope({super.key, required this.child});
