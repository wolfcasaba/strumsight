...
/// `SsCard`, `SsSection`, `SsSwitchRow`) are present, regardless of whether
/// the ambient app theme (`core/theme/app_theme.dart`) already provides
/// them.
///
...
final class ShareThemeScope extends StatelessWidget {
  const ShareThemeScope({super.key, required this.child});
