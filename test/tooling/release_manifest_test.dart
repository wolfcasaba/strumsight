...
void _requirePython3() {
  // No skip path: if python3 is missing, `Process.runSync` throws
  // ProcessException the first time a test in this group calls it, which
  // fails that test — exactly the "PIROS, not skip" contract A7 measures.
}
