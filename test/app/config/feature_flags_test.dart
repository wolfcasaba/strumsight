...
void main() {
  // E14 (Ch14) brought its own flag cells in a second entry point so the
  // two lines could grow independently; both run here.
  ch14Main();
...
void ch14Main() {
  ...
  group('Ch14 recognition rollout flags', () {
    ...
    test('the new flags participate in value semantics and toString — a '
      ...
      expect(defaults.toString(), contains('strumModelRolloutStage: off'));
      expect(defaults.toString(), contains('chordModelRolloutStage: off'));
