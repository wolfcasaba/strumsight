...
void main() {
  test(
    'production screen inventory is stable, sorted, and excludes test trees',
    () {
      ...
      expect(first.screenPaths, hasLength(62));
      ...
      expect(
        first.overlayPaths,
        orderedEquals([...first.overlayPaths]..sort()),
      );
      expect(
        first.overlayPaths,
      ...
      expect(
        () => first.overlayPaths.add('unexpected'),
        throwsUnsupportedError,
      );
    },
  );
