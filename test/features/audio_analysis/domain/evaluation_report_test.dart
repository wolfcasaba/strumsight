...
GroundTruthManifest _sampleManifest() => GroundTruthManifest(
  ...
  cases: [
    ...
    GroundTruthCase(
      ...
      detected: AnnotationSet(
        events: [
          EvalEvent(id: 'm1', timeMs: 10, type: EvalEventType.noteOnset),
        ],
...
void main() {
  ...
  test('the same manifest run twice produces a byte-identical report JSON', () {
  ...
  test('the report JSON never contains an absolute filesystem path or a '
      'username', () {
  ...
  test(
    'EvaluationManifestParser + EvaluationRunner round-trip the ci_manifest.json fixture deterministically',
    () async {
