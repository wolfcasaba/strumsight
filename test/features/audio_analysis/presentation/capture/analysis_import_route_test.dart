...
Future<_Rig> _openAnalysisHome(
  ...
  final container = ProviderContainer(
    overrides: [
      ...
      // The merged capture flow (E17-R02) persists a completed run through
      // the repository; the import CTA reaches it, so the seam has to be
      // overridden here the way `capture_wiring_test.dart` does.
...
/// The import cells never complete a run, so nothing is ever written; the
/// repository only has to EXIST for the capture flow's composition.
