...
void main() {
  group('V2AnalysisRunner (ADR 0254)', () {
    ...
    test(
      'A2/A3 — PCM in produces an AnalysisDocument out through the full '
      '20-stage chain composed from buildFullAnalysisStages()',
      () async {
    ...
    for (final cell
      ...
      test('A5 — ${cell.label}: document born, timing metrics presence '
        ...
        final hasTimingMetrics = document!.metrics.any(
          (metric) => metric.id == AnalysisMetricId.timingTargetMeanAbsoluteError,
        );
...
AnalysisDocument _seedDocument({required AnalysisMode mode}) => AnalysisDocument(
  id: 'seed-document',
