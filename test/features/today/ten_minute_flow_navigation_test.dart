...
Future<GoRouter> _pumpTodayHub(
  ...
  await tester.pumpWidget(
    ProviderScope(
      overrides: [
        ...preferenceOverrides(),
        // A day whose plan names NO curriculum rung. With one, the hero copy
        // names that rung and the primary CTA continues it (`/curriculum`) —
        // a different, older rule that these chain cells are not about
        // (`TodayPlanSnapshot.recommendedMissionId`).
