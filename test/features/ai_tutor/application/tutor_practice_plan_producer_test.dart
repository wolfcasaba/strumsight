...
import 'package:strumsight/features/practice_generator/data/adapter/practice_engine_catalog_reader.dart';
...
PracticeCatalogSnapshot _catalog() => PracticeEngineCatalogReader(
  definitions: const BuiltinPracticeCatalog().all(),
).read();
